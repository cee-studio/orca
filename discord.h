 ...
 */
void discord_add_intents(
  struct discord *client, enum discord_gateway_intents code);
/**
 ...
 */
void discord_set_event_scheduler(
  struct discord *client, discord_event_scheduler_cb callback);
/**
...
void discord_set_on_command(
  struct discord *client, char *command, discord_message_cb callback);
/**
 ...
 * @param callback the callback that will be executed
 */
void discord_set_on_event_raw(
  struct discord *client, discord_event_raw_cb callback);
/**
...
void discord_set_on_channel_create(
  struct discord *client, discord_channel_cb callback);
/**
...
void discord_set_on_guild_role_create(
  struct discord *client, discord_guild_role_cb callback);
/**
...
void discord_set_on_guild_role_delete(
  struct discord *client, discord_guild_role_delete_cb callback);
/**
...
void discord_set_on_guild_member_add(
  struct discord *client, discord_guild_member_cb callback);
/**
...
void discord_set_on_guild_ban_add(
  struct discord *client, discord_guild_ban_cb callback);
/**
...
void discord_set_on_interaction_create(
  struct discord *client, discord_interaction_cb callback);
/**
...
void discord_set_on_message_create(
  struct discord *client, discord_message_cb callback);
void discord_set_on_sb_message_create(
  struct discord *client, discord_sb_message_cb callback);
/**
...
void discord_set_on_message_update(
  struct discord *client, discord_message_cb callback);
void discord_set_on_sb_message_update(
  struct discord *client, discord_sb_message_cb callback);
/**
...
void discord_set_on_message_delete(
  struct discord *client, discord_message_delete_cb callback);
/*
...
void discord_set_on_voice_state_update(
  struct discord *client, discord_voice_state_update_cb callback);
/**
 ...
 */
void discord_set_voice_cbs(
  struct discord *client, struct discord_voice_cbs *callbacks);
/**
 ...
 */
void discord_set_presence(
  struct discord *client, struct discord_presence_status *presence);
/**
 ...
 * request
 */
ORCAcode discord_get_followup_message(
  struct discord *client,
  const u64_snowflake_t application_id,
  const char interaction_token[],
  const u64_snowflake_t message_id,
 ...
 * request
 */
ORCAcode discord_delete_followup_message(
  struct discord *client,
  const u64_snowflake_t application_id,
  const char interaction_token[],
  const u64_snowflake_t message_id);
 ...
 * request
 */
ORCAcode discord_modify_channel(
  struct discord *client,
  const u64_snowflake_t channel_id,
 ...
 * request
 */
ORCAcode discord_delete_channel(
  struct discord *client,
  const u64_snowflake_t channel_id,
  struct discord_channel *p_channel);
/** @} */
 ...
 * request
 */
ORCAcode discord_get_channel_message(
  struct discord *client,
  const u64_snowflake_t channel_id,
  const u64_snowflake_t message_id,
  struct discord_message *p_message);
 ...
 * request
 */
ORCAcode discord_create_message(
  struct discord *client,
  const u64_snowflake_t channel_id,
 ...
 * request
 */
ORCAcode discord_crosspost_message(
  struct discord *client,
  const u64_snowflake_t channel_id,
  const u64_snowflake_t message_id,
  struct discord_message *p_message);
 ...
 * request
 */
ORCAcode discord_create_reaction(
  struct discord *client,
  const u64_snowflake_t channel_id,
  const u64_snowflake_t message_id,
 ...
 * request
 */
ORCAcode discord_delete_own_reaction(
  struct discord *client,
  const u64_snowflake_t channel_id,
  const u64_snowflake_t message_id,
  const u64_snowflake_t emoji_id,
 ...
 * request
 */
ORCAcode discord_delete_user_reaction(
  struct discord *client,
  const u64_snowflake_t channel_id,
  const u64_snowflake_t message_id,
  const u64_snowflake_t user_id,
 ...
 * request
 */
ORCAcode discord_get_reactions(
  struct discord *client,
 ...
 * request
 */
ORCAcode discord_delete_all_reactions(
  struct discord *client,
  u64_snowflake_t channel_id,
  u64_snowflake_t message_id);
/** @} */
 ...
 * request
 */
ORCAcode discord_delete_message(
  struct discord *client,
  u64_snowflake_t channel_id,
  u64_snowflake_t message_id);
/** @} */
 ...
 * request
 */
ORCAcode discord_bulk_delete_messages(
  struct discord *client,
  u64_snowflake_t channel_id,
 ...
 * request
 */
ORCAcode discord_get_channel_invites(
  struct discord *client,
  const u64_snowflake_t channel_id,
 ...
 * request
 */
ORCAcode discord_delete_channel_permission(
  struct discord *client,
  const u64_snowflake_t channel_id,
  const u64_snowflake_t overwrite_id);
/** @} */
 ...
 *  @{ */
ORCAcode discord_trigger_typing_indicator(
  struct discord *client, u64_snowflake_t channel_id);
/** @} */
 ...
 *  @{ */
ORCAcode discord_get_pinned_messages(
  struct discord *client,
  const u64_snowflake_t channel_id,
  NTL_T(struct discord_message) * p_messages);
/** @} */
 ...
 * @
 */
ORCAcode discord_unpin_message(
  struct discord *client,
  const u64_snowflake_t channel_id,
  const u64_snowflake_t message_id);
/** @} */
 ...
 */
ORCAcode discord_group_dm_remove_recipient(
  struct discord *client,
  const u64_snowflake_t channel_id,
  const u64_snowflake_t user_id);
/** @} */
 ...
 *  @{ */
ORCAcode discord_leave_thread(
  struct discord *client, const u64_snowflake_t channel_id);
/** @} */

/** @defgroup DiscordRemoveThreadMember
 *  @{ */
ORCAcode discord_remove_thread_member(
  struct discord *client,
  const u64_snowflake_t channel_id,
  const u64_snowflake_t user_id);
/** @} */
 ...
 *  @{ */
ORCAcode discord_list_thread_members(
  struct discord *client,
  const u64_snowflake_t channel_id,
 ...
 *  @{ */
ORCAcode discord_list_guild_emojis(
  struct discord *client,
  const u64_snowflake_t guild_id,
 ...
 *  @{ */
ORCAcode discord_get_guild_emoji(
  struct discord *client,
  const u64_snowflake_t guild_id,
  const u64_snowflake_t emoji_id,
 ...
 *  @{ */
ORCAcode discord_delete_guild_emoji(
  struct discord *client,
  const u64_snowflake_t guild_id,
  const u64_snowflake_t emoji_id);
/** @} */
 ...
 * request
 */
ORCAcode discord_get_guild_channels(
  struct discord *client,
  const u64_snowflake_t guild_id,
 ...
 *  @{ */
ORCAcode discord_get_guild_member(
  struct discord *client,
 ...
 * request
 */
ORCAcode discord_add_guild_member_role(
  struct discord *client,
  const u64_snowflake_t guild_id,
  const u64_snowflake_t user_id,
  const u64_snowflake_t role_id);
 ...
 * request
 */
ORCAcode discord_remove_guild_member_role(
  struct discord *client,
  const u64_snowflake_t guild_id,
  const u64_snowflake_t user_id,
  const u64_snowflake_t role_id);
 ...
 * request
 */
ORCAcode discord_remove_guild_member(
  struct discord *client,
  const u64_snowflake_t guild_id,
  const u64_snowflake_t user_id);
/** @} */
 ...
 * request
 */
ORCAcode discord_get_guild_bans(
  struct discord *client,
  const u64_snowflake_t guild_id,
 ...
 * request
 */
ORCAcode discord_get_guild_ban(
  struct discord *client,
  const u64_snowflake_t guild_id,
  const u64_snowflake_t user_id,
 ...
 *  @{ */
ORCAcode discord_remove_guild_ban(
  struct discord *client,
  const u64_snowflake_t guild_id,
  const u64_snowflake_t user_id);
/** @} */
 ...
 *  @{ */
ORCAcode discord_get_guild_roles(
  struct discord *client,
  const u64_snowflake_t guild_id,
 ...
 * request
 */
ORCAcode discord_get_guild_invites(
  struct discord *client,
  const u64_snowflake_t guild_id,
  NTL_T(struct discord_invite) * p_invites);
 ...
 * request
 */
ORCAcode discord_get_guild_vanity_url(
  struct discord *client,
  const u64_snowflake_t guild_id,
 ...
 * request
 */
ORCAcode discord_delete_guild_role(
  struct discord *client,
  const u64_snowflake_t guild_id,
  const u64_snowflake_t role_id);
/** @} */
 ...
 *  @{ */
ORCAcode discord_delete_invite(
  struct discord *client, char *invite_code, struct discord_invite *p_invite);
/** @} */

/** @defgroup DiscordGetUser
 *  @{ */
ORCAcode discord_get_user(
  struct discord *client,
  const u64_snowflake_t user_id,
 ...
 *  @{ */
ORCAcode discord_get_current_user(
  struct discord *client, struct discord_user *p_user);
ORCAcode sb_discord_get_current_user(
  struct discord *client, struct sized_buffer *p_sb_user);
/** @} */

/** @defgroup DiscordGetCurrentUserGuilds
 *  @{ */
ORCAcode discord_get_current_user_guilds(
  struct discord *client, NTL_T(struct discord_guild) * p_guilds);
/** @} */

/** @defgroup DiscordLeaveGuild
 *  @{ */
ORCAcode discord_leave_guild(
  struct discord *client, const u64_snowflake_t guild_id);
/** @} */

/** @defgroup DiscordCreateDm
 *  @{ */
ORCAcode discord_create_dm(
  struct discord *client,
 ...
 *  @{ */
ORCAcode discord_create_group_dm(
  struct discord *client,
 ...
 * request
 */
ORCAcode discord_get_user_connections(
  struct discord *client, NTL_T(struct discord_connection) * p_connections);
/** @} */
 ...
 * request
 */
ORCAcode discord_list_voice_regions(
  struct discord *client,
  NTL_T(struct discord_voice_region) * p_voice_regions);
/** @} */
 ...
 * request
 */
ORCAcode discord_create_webhook(
  struct discord *client,
  const u64_snowflake_t channel_id,
 ...
 * request
 */
ORCAcode discord_get_channel_webhooks(
  struct discord *client,
  const u64_snowflake_t channel_id,
 ...
 * request
 */
ORCAcode discord_get_guild_webhooks(
  struct discord *client,
  const u64_snowflake_t guild_id,
  NTL_T(struct discord_webhook) * p_webhooks);
/** @} */
 ...
 * request
 */
ORCAcode discord_get_webhook_with_token(
  struct discord *client,
  const u64_snowflake_t webhook_id,
 ...
 * request
 */
ORCAcode discord_modify_webhook(
  struct discord *client,
  const u64_snowflake_t webhook_id,
 ...
 * request
 */
ORCAcode discord_delete_webhook(
 ...
 * request
 */
ORCAcode discord_delete_webhook_with_token(
  struct discord *client,
  const u64_snowflake_t webhook_id,
  const char webhook_token[]);
/** @} */
 ...
 * request
 */
ORCAcode discord_execute_webhook(
  struct discord *client,
  const u64_snowflake_t webhook_id,
  const char webhook_token[],
 ...
 * request
 */
ORCAcode discord_get_webhook_message(
  struct discord *client,
  const u64_snowflake_t webhook_id,
  const char webhook_token[],
  const u64_snowflake_t message_id,
 ...
 * request
 */
ORCAcode discord_delete_webhook_message(
  struct discord *client,
  const u64_snowflake_t webhook_id,
  const char webhook_token[],
  const u64_snowflake_t message_id);
 ...
 *  @{ */
ORCAcode discord_get_gateway(
  struct discord *client, struct sized_buffer *p_json);
/** @} */

/** @defgroup DiscordGetGatewayBot
 *  @{ */
ORCAcode discord_get_gateway_bot(
  struct discord *client, struct sized_buffer *p_json);
/** @} */
...
void discord_embed_set_description(
  struct discord_embed *embed, char format[], ...);
...
void discord_embed_set_provider(
  struct discord_embed *embed, char name[], char url[]);
...
void discord_embed_add_field(
  struct discord_embed *embed, char name[], char value[], bool Inline);
/** @} */
 ...
 */
void discord_presence_add_activity(
  struct discord_presence_status *presence, struct discord_activity *activity);
/** @} */
 ...
 * request
 */
ORCAcode discord_get_guild_template(
  struct discord *client,
  char *code,
