...
void
log_on_channel_create(struct discord *client, const struct discord_user *bot,
...
void
log_on_channel_update(struct discord *client, const struct discord_user *bot,
                      const struct discord_channel *channel)
{
...
void
log_on_channel_delete(struct discord *client, const struct discord_user *bot,
                      const struct discord_channel *channel)
{
...
void
log_on_thread_create(struct discord *client, const struct discord_user *bot,
...
void
log_on_thread_update(struct discord *client, const struct discord_user *bot,
                     const struct discord_channel *thread)
{
...
void
log_on_thread_delete(struct discord *client, const struct discord_user *bot,
                     const struct discord_channel *thread)
{
...
void
on_channel_create(struct discord *client, const struct discord_user *bot,
...
void
on_channel_rename_this(struct discord *client, const struct discord_user *bot,
                       const struct discord_message *msg)
{
  if (msg->author->bot)
    return;
...
void
on_channel_delete_this(struct discord *client, const struct discord_user *bot,
                       const struct discord_message *msg)
{
  if (msg->author->bot)
    return;
...
void
on_channel_get_invites(struct discord *client, const struct discord_user *bot,
                       const struct discord_message *msg)
{
  if (msg->author->bot)
    return;
...
void
on_channel_start_thread(struct discord *client, const struct discord_user *bot,
                        const struct discord_message *msg)
{
  if (msg->author->bot)
    return;
