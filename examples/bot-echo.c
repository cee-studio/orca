...
{
  log_info("Echo-Bot succesfully connected to Discord as %s#%s!", bot->username,
           bot->discriminator);
}
...
void on_message_create(struct discord *client, const struct discord_user *bot,
...
void on_message_update(struct discord *client, const struct discord_user *bot,
                       const struct discord_message *msg)
{
...
void on_message_delete(struct discord *client, const struct discord_user *bot,
