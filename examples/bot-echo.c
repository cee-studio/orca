...
on_reaction_add(struct discord *client, const struct discord_user *bot,
                const uint64_t user_id, const uint64_t channel_id,
                const uint64_t message_id, const uint64_t guild_id,
...
void
on_message_create(struct discord *client, const struct discord_user *bot,
...
void
on_message_update(struct discord *client, const struct discord_user *bot,
                  const struct discord_message *msg)
{
...
void
on_message_delete(struct discord *client, const struct discord_user *bot,
                  const uint64_t id, const uint64_t channel_id,
...
void
on_message_delete_bulk(struct discord *client, const struct discord_user *bot,
                       const NTL_T(ja_u64) ids, const uint64_t channel_id,
                       const uint64_t guild_id)
{
  char text[128];
  snprintf(text,
