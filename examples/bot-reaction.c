...
void
on_get_users(struct discord *client, const struct discord_user *bot,
...
void
on_delete_all(struct discord *client, const struct discord_user *bot,
              const struct discord_message *msg)
{
  if (msg->author->bot || !msg->referenced_message)
    return;
...
void
on_delete_self(struct discord *client, const struct discord_user *bot,
               const struct discord_message *msg)
{
  if (msg->author->bot || !msg->referenced_message)
    return;

  discord_delete_own_reaction(client,
                              msg->referenced_message->channel_id,
                              msg->referenced_message->id,
                              0,
                              msg->content);
...
void
on_delete_user(struct discord *client, const struct discord_user *bot,
               const struct discord_message *msg)
{
  if (msg->author->bot || !msg->referenced_message)
    return;
  ...
  discord_delete_user_reaction(client,
                               msg->referenced_message->channel_id,
                               msg->referenced_message->id,
                               user_id,
                               0,
