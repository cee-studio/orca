  ...
  while (1) {
    ...
    if (0 == strcasecmp(cmd_action, "LIST")) {
      ...
      if (guild_id)
        ...
        code = discord_get_global_application_commands(client, g_application_id,
                                                       &app_cmds);
...
int main(int argc, char* argv[])
{
  ...
  discord_set_on_application_command_create(client,
                                            &log_on_application_command_create);
  discord_set_on_application_command_update(client,
                                            &log_on_application_command_update);
  discord_set_on_application_command_delete(client,
                                            &log_on_application_command_delete);
