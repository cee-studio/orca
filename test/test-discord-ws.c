...
void
on_disconnect(struct discord *client, const struct discord_user *bot,
...
void
on_spam(struct discord *client, const struct discord_user *bot,
        const struct discord_message *msg)
{
...
void
on_stop(struct discord *client, const struct discord_user *bot,
        const struct discord_message *msg)
{
  if (msg->author->bot)
    return;
...
void
on_force_error(struct discord *client, const struct discord_user *bot,
               const struct discord_message *msg)
{
  if (msg->author->bot)
    return;
...
void
on_ping(struct discord *client, const struct discord_user *bot,
        const struct discord_message *msg)
{
  if (msg->author->bot)
    return;
...
scheduler(struct discord *client, struct discord_user *bot,
          struct sized_buffer *data, enum discord_gateway_events event)
{
