...
void on_connect_cb(void* data, struct websockets* ws, struct ws_info* info,
...
void on_text_cb(void* data, struct websockets* ws, struct ws_info* info,
...
void on_ping_cb(void* data, struct websockets* ws, struct ws_info* info,
...
void on_pong_cb(void* data, struct websockets* ws, struct ws_info* info,
                const char* reason, size_t len)
{
  (void)data;
  (void)ws;
...
void on_close_cb(void* data, struct websockets* ws, struct ws_info* info,
